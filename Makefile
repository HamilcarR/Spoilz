#############################################################################
# Makefile for building: Spoilz
# Generated by qmake (3.1) (Qt 5.13.2)
# Project:  Hack.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile Hack.pro
#############################################################################
...
CXXFLAGS      = -pipe -std=c++17 -Wall -Wextra -pedantic -g -Wall -W -D_REENTRANT -fPIC $(DEFINES)
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Spoilz1.0.0
DISTDIR = /home/hamilcar/Desktop/Projects/Nethack/.tmp/Spoilz1.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) -lncurses /usr/lib/libQt5Widgets.so /usr/lib/libQt5Gui.so /usr/lib/libQt5Core.so /usr/lib/libGL.so -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		Hack.pro includes/Constants.h sources/main.cpp
QMAKE_TARGET  = Spoilz
DESTDIR       = 
TARGET        = Spoilz
...
Makefile: Hack.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents includes/Constants.h $(DISTDIR)/
	$(COPY_FILE) --parents sources/main.cpp $(DISTDIR)/
...
moc_predefs.h: /usr/lib/qt/mkspecs/features/data/dummy.cpp
	g++ -pipe -std=c++17 -Wall -Wextra -pedantic -g -Wall -W -dM -E -o moc_predefs.h /usr/lib/qt/mkspecs/features/data/dummy.cpp
