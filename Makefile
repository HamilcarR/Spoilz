...
# Project:  Hack.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -o Makefile Hack.pro
#############################################################################
...
DISTDIR = /home/hamilcar/Desktop/Projects/Spoilz/.tmp/Spoilz1.0.0
LINK          = g++
LFLAGS        = 
...
Inventory.o: sources/Inventory.cpp includes/Inventory.h \
		includes/Constants.h \
		includes/GameObjects.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Inventory.o sources/Inventory.cpp
